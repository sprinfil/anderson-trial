...
<body>
    <div class="main">
        ...
        <div class="contenedor-main">
            ...
            <a href="/anderson-trial/views/usuarios_create.php" class="boton-eliminar"><button type="button"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="" style="display:flex; flex-wrap: nowrap;">
                                        <a href="usuarios_update.php?id=<?= $datos->id ?>"
                                        ...
                                        <a href="usuarios.php?id=<?= $datos->id ?>" class="boton-eliminar"
                                            onclick="alert_eliminar(event)"><button type="button" class="btn btn-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="aicon">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
