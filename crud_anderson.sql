...
CREATE TABLE IF NOT EXISTS `tareas` (
  ...
  `usuario_id` bigint DEFAULT NULL,
  `finalizada` varchar(50) DEFAULT 'FALSE',
  PRIMARY KEY (`id`),
  KEY `proyecto_id` (`proyecto_id`),
  KEY `usuario_id` (`usuario_id`),
...
INSERT INTO `tareas` (`id`, `nombre`, `fecha_finalziar`, `proyecto_id`, `usuario_id`, `finalizada`) VALUES
	(19, 'MODULO DE ODONTOGRAMA', '2024-03-21', 13, 25, 'TRUE'),
	(24, 'MODULO 1', '2024-03-13', 13, 25, 'TRUE'),
	(25, 'MODULO 2', '2024-03-22', 13, 32, 'FALSE'),
	(27, 'MODULO 4', '2024-04-03', 13, 25, 'FALSE');
